<template>
  <div class="trip-container">
    ...
    <PopOver :selectedLocation="selectedLocation" :windowSize="windowSize" :popoverPosition="popoverPosition" @toggle-info-display="toggleInfoDisplay"  @close-info-display="closeLocationInfo"/>
  ...
  >
    <div class="info-display-header">
          ...
          <div class="location-rating">
            <div class="rating-stars">
              <svg
                ...
                height="12"
                viewBox="0 0 24 24"
                :fill="star <= parseInt(selectedLocation.rating) ? '#fbbf24' : 'none'"
                stroke="currentColor"
                stroke-width="2"
                class="star-icon"
              >
      ...
      <button @click="closeInfoDisplay" class="info-close-btn" aria-label="Close">
    ...
    <div class="info-display-content">
      ...
      <div class="quick-info-grid">
        ...
        <div class="quick-info-card transport-card">
          <div class="card-icon">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 18H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h18a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2"></path>
              <path d="M5 18a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM21 18a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"></path>
            </svg>
          </div>
          <div class="card-content">
            <span class="card-value">{{ selectedLocation.modeOfTransport }}</span>
        ...
        <div class="visit-details-card">
          <div class="detail-item">
            ...
            <div class="detail-content">
              ...
              <span class="detail-desc">{{ selectedLocation.timeOfDay }}</span>
            </div>
          </div>
          <div class="detail-item">
            ...
            <div class="detail-content">
              ...
              <span class="detail-desc">{{ selectedLocation.preference }}</span>
            </div>
          </div>
          <div class="detail-item">
            ...
            <div class="detail-content">
              ...
              <span class="detail-desc recommendation-badge">{{ selectedLocation.recommendation }}</span>
            </div>
          </div>
        </div>
      </div>
...
import { createMarkers, getUserLocation, initMap, drawTripLine, removeTripLine } from "../repos/MainFunctions"
...
const getSharedTripData = async () => {
  try {
    ...
    createMarkersWithPositioning(tripLocations.value, markers, map, selectedLocation, popoverPosition);
...
const createMarkersWithPositioning = (locations, markers, map, selectedLocation, popoverPosition) => {
